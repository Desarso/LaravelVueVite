...
<div class="container-fluid">
    ...
    <div class="row mb-1">
        ...
        <div class="col-4 col-sm-4">
            <label for="dropDownListShift">Horario</label>
            <input id="dropDownListShift" class="form-control" title="Filtro por Horario" style="width: 100%;">
        </div>
        -->
    </div>
            ...
            <div class="card" style="margin-bottom: 1rem !important;">
                ...
                <div class="card-content">
                    <div class="card-body" style="position: relative;">
                        <div id="gridClockinDevice" style="width:100%"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{ asset('js/reports/report-clockin-device.js') }}"></script>
