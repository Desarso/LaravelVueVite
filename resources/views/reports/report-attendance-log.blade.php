...
<div class="container-fluid">
    ...
    <div class="row mb-1">
        ...
        <div class="col-4 col-sm-4">
            <label for="dropDownListSchedule">Horario</label>
            <input id="dropDownListSchedule" class="form-control" title="Filtro por Horario" style="width: 100%;">
        </div>
    </div>
...
<script src="{{ asset('js/reports/report-attendance-log.js') }}"></script>
