...
<div class="container-fluid">
        ...
        <div class="col-md-12 col-12">
            <div class="card" style="margin-bottom: 1rem !important;">
                <div class="card-header">
                    <h4 class="card-title">Tareas asignadas por usuario
                    </h4>
                </div>
                <div class="card-content">
                    <div class="card-body" style="position: relative;">
                        <input id="idparentuser" class="form-control" hidden>
                        <div id="gridUserTickets" style="width:100%"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card" style="margin-bottom: 1rem !important;">
                <div class="card-header">
                    <h4 class="card-title">Tareas reportadas por usuario</h4>
                </div>
                <div class="card-content">
                    <div class="card-body" style="position: relative;">
                        <div id="gridUserReports" style="width:100%"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('page-script')
<script src="{{ asset('js/reports/report-users.js') }}"></script>
