      ...
      <div class="navbar-container content">
        <div class="navbar-collapse" id="navbar-mobile">
          <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
            ...
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="config-tasks" data-toggle="tooltip"
                  data-placement="top" title="Inicio"><i class="ficon far fa-home-lg-alt"></i></a></li>
              <li class="nav-item d-none d-lg-block"><a class="nav-link" href="config-dashboard" data-toggle="tooltip"
                  data-placement="top" title="Apps"><i class="ficon far fa-mobile"></i></a></li>
              <li class="nav-item d-none d-lg-block"><a class="nav-link" href="config-items" data-toggle="tooltip"
                  data-placement="top" title="Ítems"><i class="ficon fad fa-tools" style="color: #C72A1B"></i></a></li>
              <li class="nav-item d-none d-lg-block"><a class="nav-link" href="config-spots" data-toggle="tooltip"
                  data-placement="top" title="Spots"><i class="ficon fad fa-store-alt"></i></a></li>
              <li class="nav-item d-none d-lg-block"><a class="nav-link" href="config-users" data-toggle="tooltip"
                  data-placement="top" title="Usuarios"><i class="ficon fad fa-users" ></i></a></li>
            </ul>
            <ul class="nav navbar-nav">
              <li class="nav-item d-none d-lg-block"><a class="nav-link bookmark-star"><i
                ...
                <div class="bookmark-input search-input">
                  ...
                  <input class="form-control input" type="text" placeholder="Explore Whagons..." tabindex="0"
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ auth()->user()->firstname }}</span><span class="user-status">Available</span></div><span><img class="round"
                    src="{{ auth()->user()->urlpicture }}" alt="avatar" height="40"
                    width="40" /></span>
              </a>
