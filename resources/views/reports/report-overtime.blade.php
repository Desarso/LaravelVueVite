    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="title-modal-checklist">Aprobación de Horas extras</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-2">
                        ...
                        <input id="normal_time" type="text" class="form-control" disabled>
                    </div>
                    <div class="col">
                        <label>Tiempo y medio</label>
                        <input id="half_time" type="text" class="form-control" disabled>
                    </div>
                    <div class="col">
                        <label>Doble</label>
                ...
                <div class="row">
                    <div class="col mb-2">
                        <!-- <label>Sencilla</label> -->
                        <input id="normal_time_approve" type="time" class="form-control">
                    </div>
                    <div class="col">
                        <!-- <label>Tiempo y medio</label> -->
                        <input id="half_time_approve" type="time" class="form-control">
                    </div>
                    <div class="col">
                        <!-- <label>Doble</label> -->
            ...
            <div class="modal-footer">
                <button type="button" data-status="REPROBATE"
                    class="btn btn-danger btn-md btn-block waves-effect waves-light btn-status">Reprobar</button>
                <button type="button" data-status="APPROVED"
                    class="btn btn-success btn-md btn-block waves-effect waves-light btn-status">Aprobar</button>
            </div>
        </div>
    </div>
</div>
...
@section('page-script')
<script src="{{ asset('js/reports/report-overtime.js') }}"></script>
